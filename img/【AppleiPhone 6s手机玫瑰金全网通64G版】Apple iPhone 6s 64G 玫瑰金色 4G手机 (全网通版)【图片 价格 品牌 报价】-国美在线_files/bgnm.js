...
beheGuidClass.prototype.sendUrl = function(data) {
    ...
    var c = "http://rtb.behe.com/gnm?si=";
    c = c + a;
    ...
    if (data.at == "arrive") {
        ...
        var str_one = "http://rtb.behe.com/tracker/t.gif?si=";
        str_one = str_one + str_two;
        //_this.createImg(str_one);
        //setTimeout(function(){
            _this.createImg(str_one);
        //},500);        
        // _this.beheActiveLog(data, str_one, 'http://rtb.behe.com/tracker/t.gif');
        // }
    ...
    _this.createImg(c);
    // _this.beheActiveLog(data, c, 'http://rtb.behe.com/gnm');
}
